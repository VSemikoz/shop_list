...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i18.ListOfListsUseCaseBase>(() =>
        _i18.ListOfListsUseCase(listRepository: gh<_i10.ListRepositoryBase>()));
    ...
    gh.factoryParam<_i20.CategoryEditBloc, _i16.EditCategoryTransaction,
        _i5.RouterEventSink>((
      transaction,
      router,
    ) =>
    ...
    gh.factoryParam<_i21.ListDetailsBloc, _i16.ListDetailsTransaction,
        _i5.RouterEventSink>((
      transaction,
      router,
    ) =>
        _i21.ListDetailsBloc(
          transaction: transaction,
          router: router,
          useCase: gh<_i17.ListDetailsUseCaseBase>(),
        ));
